...
class HKJCResultDownloader:
    ...
    def _get_race_dates(self) -> List[Dict]:
        ...
        dates_2025 = [
            ...
            # {'date': date(2026, 2, 22), 'course': 'ST'},
            # {'date': date(2026, 2, 25), 'course': 'HV'},
            # {'date': date(2026, 3, 1), 'course': 'ST'},
            # {'date': date(2026, 3, 4), 'course': 'HV'},
            # {'date': date(2026, 3, 8), 'course': 'ST'},
            # {'date': date(2026, 3, 11), 'course': 'HV'},
            # {'date': date(2026, 3, 15), 'course': 'ST'},
            # {'date': date(2026, 3, 18), 'course': 'HV'},
            # {'date': date(2026, 3, 22), 'course': 'ST'},
            # {'date': date(2026, 3, 25), 'course': 'HV'},
            # {'date': date(2026, 3, 29), 'course': 'ST'},
            # {'date': date(2026, 4, 1), 'course': 'ST'},
            # {'date': date(2026, 4, 6), 'course': 'ST'},
            # {'date': date(2026, 4, 8), 'course': 'HV'},
            # {'date': date(2026, 4, 12), 'course': 'ST'},
            # {'date': date(2026, 4, 15), 'course': 'HV'},
            # {'date': date(2026, 4, 19), 'course': 'ST'},
            # {'date': date(2026, 4, 22), 'course': 'HV'},
